...
def _get_kwargs(
    ...
    *,
    ...
    form_data: PatchedEmailNotificationProfile,
    multipart_data: PatchedEmailNotificationProfile,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (str):
        multipart_data (PatchedEmailNotificationProfile): An EmailProfile contains settings for
